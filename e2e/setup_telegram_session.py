...
API_ID = int(os.getenv("TELEGRAM_API_ID") or "39591687")
API_HASH = os.getenv("TELEGRAM_API_HASH") or "e766492e7fc11526d45b530514355843"
...
async def main() -> None:
    ...
    phone = input("Enter your phone number (e.g. +19187408364): ").strip()
